...
public class RequestConditionTest {
    ...
    public void ping() {
        ...
        Assert.assertEquals("DEFAULT handler", restTemplate.getForObject("http://localhost:8080/", String.class));
        Assert.assertEquals("DEFAULT handler", restTemplate.getForObject("http://localhost:8080/?qwerty", String.class));
        Assert.assertEquals("A handler", restTemplate.getForObject("http://localhost:8080/?a", String.class));
        Assert.assertEquals("B handler", restTemplate.getForObject("http://localhost:8080/?b", String.class));
