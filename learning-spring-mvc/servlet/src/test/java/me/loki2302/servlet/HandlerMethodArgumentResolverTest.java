...
public class HandlerMethodArgumentResolverTest {
    ...
    public void ping() {
        ...
        Assert.assertEquals("hello there 1", restTemplate.getForObject("http://localhost:8080/", String.class));
        Assert.assertEquals("hello there 2", restTemplate.getForObject("http://localhost:8080/", String.class));
        Assert.assertEquals("hello there 3", restTemplate.getForObject("http://localhost:8080/", String.class));
    }
