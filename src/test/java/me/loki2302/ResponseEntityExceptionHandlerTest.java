...
public class ResponseEntityExceptionHandlerTest {
    ...
    public void tryThrowRuntimeException() {
        String url = relativeTo(fromHttpUrl("http://localhost:8080"))
                .withMethodCall(on(DummyController.class).throwRuntimeException())
                .toUriString();

        ResponseEntity<ErrorDto> responseEntity = restTemplate.getForEntity(url, ErrorDto.class);
        assertEquals(HttpStatus.INTERNAL_SERVER_ERROR, responseEntity.getStatusCode());
        assertEquals("throwable handler", responseEntity.getBody().message);
    }

    @Test
    public void tryThrowSomethingNotFoundApiException() {
        String url = relativeTo(fromHttpUrl("http://localhost:8080"))
                .withMethodCall(on(DummyController.class).throwSomethingNotFoundApiException())
                .toUriString();

        ResponseEntity<ErrorDto> responseEntity = restTemplate.getForEntity(url, ErrorDto.class);
        assertEquals(HttpStatus.NOT_FOUND, responseEntity.getStatusCode());
        assertEquals("something not found", responseEntity.getBody().message);
    }

    @Test
    public void tryPostRequestWhenResourceOnlySupportsGet() {
        String url = relativeTo(fromHttpUrl("http://localhost:8080"))
                .withMethodCall(on(DummyController.class).handleGet())
                .toUriString();

        ResponseEntity<ErrorDto> responseEntity = restTemplate.postForEntity(url, null, ErrorDto.class);
        assertEquals(HttpStatus.METHOD_NOT_ALLOWED, responseEntity.getStatusCode());
        assertEquals("handleHttpRequestMethodNotSupported", responseEntity.getBody().message);
    }
    ...
    public void tryHandleMissingPathVariable() {
        ...
        ResponseEntity<ErrorDto> responseEntity = restTemplate.postForEntity(url, null, ErrorDto.class);
        assertEquals(HttpStatus.INTERNAL_SERVER_ERROR, responseEntity.getStatusCode());
        assertEquals("handleMissingPathVariable", responseEntity.getBody().message);
    }
    ...
    public void tryHandleTypeMismatch() {
        ...
        assertEquals("handleTypeMismatch", responseEntity.getBody().message);
    }
    ...
    public void tryHandleMethodArgumentNotValid() {
        ...
        assertEquals(HttpStatus.BAD_REQUEST, responseEntity.getStatusCode());
        assertEquals("handleMethodArgumentNotValid", responseEntity.getBody().message);
    }
    ...
    public void tryHandleHttpMessageNotReadable_notJson() {
        ...
        assertEquals(HttpStatus.BAD_REQUEST, responseEntity.getStatusCode());
        assertEquals("handleHttpMessageNotReadable", responseEntity.getBody().message);
    }
    ...
    public void tryHandleHttpMediaTypeNotSupported() {
        ...
        assertEquals("handleHttpMediaTypeNotSupported", responseEntity.getBody().message);
    }
